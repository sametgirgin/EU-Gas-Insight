...
# Create tabs
tab1, tab2, tab3, tab4, tab5, tab7 = st.tabs(["Resources","EU O&G Power Plants Map and Charts", "EU LNG Terminals", "EU Gas Pipeline Map", "Oil and Gas Extraction", "Dictionary"])
